...
<div class="footer">
    <div class="alt">
        <div class="foot">
            <p>关于我们</p>
            <a href="#nowhere">企业简介</a>
            <a href="#nowhere">企业文化</a>
            <a href="#nowhere">组织机构</a>
            <a href="#nowhere">发展历程</a>
            <a href="#nowhere">企业荣誉</a>
            <a href="#nowhere">诚聘英才</a>
            <a href="#nowhere">联系我们</a>
        ...
        <div class="foot">
            <p>新闻中心</p>
            <a href="#nowhere">公司新闻</a>
            <a href="#nowhere">行业新闻</a>
        </div>
        <div class="foot">
            <p>产品及解决方案</p>
            <a href="#nowhere">产品系列</a>
            <a href="#nowhere">解决方案</a>
        </div>
        <div class="foot">
            <p>研发与创新</p>
            <a href="#nowhere">核心技术</a>
            <a href="#nowhere">技术创新</a>
        </div>
        <div class="foot">
            <p>经典案例</p>
            <a href="#nowhere">智慧城市</a>
            <a href="#nowhere">智慧高速</a>
            <a href="#nowhere">智慧家居</a>
            <a href="#nowhere">智慧网络</a>
        </div>
        <div class="foot">
            <p>服务支持</p>
            <a href="#nowhere">技术支持</a>
            <a href="#nowhere">服务网络</a>
            <a href="#nowhere">资料下载</a>
            <a href="#nowhere">公司理念</a>
        </div>
        <div class="foot">
            <p>关注我们</p>
            <img src="img\fore\wechat2.png" />
        </div>
    </div>
    <div style="border-top:1px #1F1F1F solid;">
        <p class="alt" style="color:#999; line-height:0;">@ 版权所有：华中科技大学软件学院    
            <span>技术支持：java+ssm+github</span>
            <a href="#nowhere" target="_blank" style="color:#999;">HUSTER</a>
            <span style="float:right;">地址：韵苑16栋</span>
        </p>
    </div>
</div>